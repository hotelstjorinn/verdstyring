...
def saekja_raungogn(hotel_dict, fjoldi_daga):
    ...
    # Hér er breytingin: Við lykkjum í gegnum nafn OG fjölda herbergja
    for hotel, herbergi in hotel_dict.items():
        try:
            ...
            for i in range(fjoldi_daga):
                ...
                # Bætum rétta herbergjafjöldanum við gögnin fyrir þetta hótel
                gogn.append({
...
def main():
    ...
    # Breytt í orðabók (dict) til að geyma bæði nafn og fjölda herbergja
    if 'valin_hotel' not in st.session_state:
        st.session_state['valin_hotel'] = {}

    st.sidebar.header("Leit")
    
    # Nýtt innsláttarform fyrir hótel og herbergjafjölda
